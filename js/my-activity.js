...
const activities = [
    ...
    },
    {
        ...
        links: [
            { text: 'Chaiyo GCP Cloud Bangkok Event Link', href: ' https://gdg.community.dev/events/details/google-gdg-cloud-bangkok-presents-chaiyogcp-season-4-code-along-session-online/' },
        ],
